...
parser.add_argument('--resume', default='1031/NoisyStudent__no_robust_teacher__drop0.5__alpha0.5_gamma1_set0(1)_loop1', help='exp_id to load student ckpt to serve as the teacher')
