...
def get_args():
    ...
    parser.add_argument('--out-dir', default='fast_kdiga_output/fast_kdiga_with_grad_align/cos_iga/', type=str, help='Output directory')
    ...
    parser.add_argument('--description', default='Implemented fast kdiga with gradient alignment, both iga and grad align uses cosine similarity', type=str)
...
def main():
    ...
    model_names = ['Rebuffi2021Fixing_70_16_cutmix_extra', 'Gowal2021Improving_28_10_ddpm_100m']
